...
by A1 and the MCP search gateways through ``OMNIINFRA_EMBEDDING_CACHE_PATH``.
"""
...
def default_cache_path() -> Path:
    ...
    configured = os.getenv("OMNIINFRA_EMBEDDING_CACHE_PATH")
    if configured:
...
class QwenEmbeddingCache:
    ...
    def __init__(
        ...
        *,
        ...
        self.model = model or os.getenv("OMNIINFRA_EMBEDDING_MODEL", DEFAULT_EMBEDDING_MODEL)
        self.base_url = (base_url or os.getenv("OMNIINFRA_EMBEDDING_BASE_URL") or DEFAULT_EMBEDDING_BASE_URL).rstrip("/")
        self.api_key = api_key or os.getenv("DASHSCOPE_API_KEY") or os.getenv("QWEN_API_KEY")
        self.batch_size = max(1, int(batch_size or os.getenv("OMNIINFRA_EMBEDDING_BATCH_SIZE", DEFAULT_EMBEDDING_BATCH_SIZE)))
        self.timeout_seconds = float(timeout_seconds or os.getenv("OMNIINFRA_EMBEDDING_TIMEOUT_SECONDS", "60"))
