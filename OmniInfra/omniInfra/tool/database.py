...
from omniInfra.utils import parse_hpo_obo
...
def query_pubmed(query: str, max_papers: int = 10, max_retries: int = 3) -> dict:
    """Compatibility alias for :func:`omniInfra.tool.literature.query_pubmed`."""
    from omniInfra.tool.literature import query_pubmed as literature_query_pubmed
...
def query_pdb_identifiers(identifiers, return_type="entry", download=False, attributes=None, output_dir=None):
    ...
    resolved_output_dir = os.path.abspath(
        os.path.expanduser(
            output_dir
            or os.environ.get("OMNIINFRA_TASK_OUTPUT_DIR")
...
def query_pharos_target(
    ...
    from omniInfra.tool._a1_evidence_tools import query_pharos_target_impl
...
def query_opentargets_genetic_evidence(
    ...
    from omniInfra.tool._a1_evidence_tools import query_opentargets_genetic_evidence_impl
...
def query_gtex_expression(
    ...
    from omniInfra.tool._a1_evidence_tools import query_gtex_expression_impl
...
def query_depmap_gene_dependency(
    ...
    from omniInfra.tool._a1_evidence_tools import query_depmap_gene_dependency_impl
