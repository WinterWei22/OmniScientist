description = [
    ...
    {
        "description": "List available protocol files in the local omniInfra/tool/protocols/ directory. Includes protocols from Addgene and Thermo Fisher Scientific.",
    ...
    {
        "description": "Read the contents of a local protocol file from omniInfra/tool/protocols/. Use list_local_protocols() first to find available protocol filenames.",
