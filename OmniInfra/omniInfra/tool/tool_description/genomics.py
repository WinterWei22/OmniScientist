description = [
    {
        ...
        "optional_parameters": [
            ...
            {
                "default": None,
                "description": "Optional language model override; defaults to the central Qwen3.8 tool model",
                "name": "llm",
                "type": "str",
            },
            {
    ...
    {
        "name": "analyze_crispr_screen_with_mageck",
        "description": "Run the Docker-only MAGeCK test workflow on a pooled CRISPR sgRNA count table and return native positive- and negative-selection results.",
        "required_parameters": [
            {
                "name": "count_table_path",
                "type": "str",
                "description": "Local tab-delimited MAGeCK sgRNA count table; FASTQ input is not accepted.",
                "default": None,
            },
            {
                "name": "treatment_samples",
                "type": "List[str]",
                "description": "Treatment sample column names present in the count table.",
                "default": None,
            },
            {
                "name": "control_samples",
                "type": "List[str]",
                "description": "Control sample column names present in the count table.",
                "default": None,
            },
            {
                "name": "output_dir",
                "type": "str",
                "description": "Dedicated local directory for native MAGeCK output files.",
                "default": None,
            },
        ],
        "optional_parameters": [
            {
                ...
                "type": "str",
                "description": "MAGeCK normalization method: median, total, control, or none.",
                "default": "median",
            },
            {
                "name": "top_n",
                "type": "int",
                "description": "Maximum positive- and negative-selection gene records to return.",
                "default": 20,
            },
        ],
    },
