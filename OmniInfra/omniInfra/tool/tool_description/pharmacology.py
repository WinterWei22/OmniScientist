description = [
    ...
    },
    {
        ...
        "optional_parameters": [
            ...
            {"name": "pretrained_models_dir", "type": "str", "description": "Directory containing uploaded official DeepPurpose model folders or ZIP archives; defaults to DEEPPURPOSE_PRETRAINED_ROOT or OmniInfra/DeepPurpose_models/pretrained_models. Missing local models fall back to official download.", "default": ""},
    ...
    },
    {
        ...
        "optional_parameters": [
            ...
            {
                "default": None,
                "description": "Directory for persisted pose files; defaults to OMNIINFRA_TASK_OUTPUT_DIR or docking_results",
                "name": "output_dir",
                "type": "str",
            },
            {
    ...
    },
    {
        ...
        "required_parameters": [
            ...
            {"name": "output_dir", "type": "str", "description": "Directory for the OmniInfra REINVENT log and result references.", "default": None},
        ],
        "optional_parameters": [
