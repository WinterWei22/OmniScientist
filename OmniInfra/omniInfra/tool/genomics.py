...
def annotate_celltype_scRNA(
    ...
    - llm (str): Optional language model override. Defaults to the central
      tool LLM configuration (Qwen3.8).
...
"""
    ...
    if llm is None:
        ...
        llm = default_config.tool_llm
        source = default_config.tool_source
    else:
        source = None
    llm = get_llm(llm, source=source)
...
def analyze_crispr_screen_with_mageck(
    ...
    """Run MAGeCK test for a treatment-versus-control pooled CRISPR count table."""
    from omniInfra.tool._a1_evidence_tools import analyze_crispr_screen_with_mageck_impl

    return analyze_crispr_screen_with_mageck_impl(
        count_table_path,
        treatment_samples,
        control_samples,
        output_dir,
