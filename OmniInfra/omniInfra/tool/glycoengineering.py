...
Functions return research-log style strings to match OmniInfra tool patterns.
"""
...
def list_glycoengineering_resources() -> str:
    ...
    lines.append("- For tight OmniInfra integration, consider adding MCP wrappers or CLI installers.")
    return "\n".join(lines)
