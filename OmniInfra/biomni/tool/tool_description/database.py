description = [
    ...
    },
    {
        ...
        "optional_parameters": [
            ...
            },
            {
                "name": "output_dir",
                "type": "str",
                "description": "Directory for downloaded coordinate files. Defaults to BIOMNI_TASK_OUTPUT_DIR when set; PDB-incompatible entries are saved as mmCIF.",
                "default": None,
            },
        ],
        "required_parameters": [
    ...
    },
    {
        ...
        "name": "query_chembl",
        "canonical_name": "biomni.tool.database.query_chembl",
