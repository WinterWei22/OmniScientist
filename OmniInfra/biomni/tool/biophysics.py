...
def prepare_proteinmd_inference(
    ...
    """
    from biomni.tool._proteinmd_runtime import prepare_request
...
def submit_proteinmd_inference(validation_token: str, gpu_policy: str = "auto") -> dict:
    ...
    from biomni.tool._proteinmd_runtime import submit_request
...
def get_proteinmd_inference(task_id: str) -> dict:
    ...
    from biomni.tool._proteinmd_runtime import get_request
