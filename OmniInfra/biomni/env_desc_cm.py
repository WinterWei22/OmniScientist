...
library_content_dict = {
    ...
    "mageck": "[Docker CLI] MAGeCK 0.5.9.5 pooled CRISPR screen analysis via quay.io/biocontainers/mageck:0.5.9.5--py310hc52dbad_9.",
    "fpocket": "[Docker CLI] fpocket 4.0 protein pocket detection via quay.io/biocontainers/fpocket:4.0.0.",
